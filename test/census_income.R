...
beta_adam <- adaglm(X_inter,y[1:500],fam_link = family, optimizer = "ADAM")
beta_adagrad <- adaglm(X_inter,y[1:500],fam_link = family, optimizer = "AdaGrad", alpha=0.1)
beta_adadelta <- adaglm(X_inter,y[1:500],fam_link = family, optimizer = "AdaDelta")
beta_adasmooth <- adaglm(X_inter,y[1:500],fam_link = family, optimizer = "AdaSmooth")
