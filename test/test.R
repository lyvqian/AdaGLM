...
run_simulation <- function() {
  ...
  return(data.frame(mse_adagrad, mse_adam, mse_adasmooth, mse_adadelta, mse_irwls, #mse_glm, 
                    acc_adagrad, acc_adam, acc_adasmooth, acc_adadelta, acc_irwls, # acc_glm, 
                    #auc_adagrad, auc_adam, auc_adasmooth, auc_adadelta, auc_glm, 
                    exec_time_adagrad, exec_time_adam, exec_time_adasmooth, exec_time_adadelta, exec_time_irwls))
}
...
boxplot(results$exec_time_adagrad, results$exec_time_adam, results$exec_time_adasmooth, 
        results$exec_time_adadelta, results$exec_time_irwls, 
        names = c("AdaGrad", "Adam", "AdaSmooth", "AdaDelta", "IRWLS"),
        main = "Execution Time",
        ylab = "Time (ms)")
