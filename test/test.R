...
run_simulation <- function() {
  ...
  auc_adasmooth <- auc(y, as.numeric(preds_adasmooth))
  auc_adadelta <- auc(y, as.numeric(preds_adadelta))
  ...
  return(data.frame(mse_adagrad, mse_adam, mse_adasmooth, mse_adadelta, mse_glm, 
                    acc_adagrad, acc_adam, acc_adasmooth, acc_adadelta, acc_glm, 
                    auc_adagrad, auc_adam, auc_adasmooth, auc_adadelta, auc_glm, 
                    exec_time_adagrad, exec_time_adam, exec_time_adasmooth, exec_time_adadelta, exec_time_glm))
}
...
boxplot(results$mse_adagrad, results$mse_adam, results$mse_adasmooth, results$mse_adadelta, results$mse_glm, 
        names = c("AdaGrad", "Adam", "AdaSmooth", "AdaDelta", "GLM"),
        main = "MSE (beta)",
        ylab = "Mean Squared Error")

boxplot(results$acc_adagrad, results$acc_adam, results$acc_adasmooth, results$acc_adadelta, results$acc_glm, 
        names = c("AdaGrad", "Adam", "AdaSmooth", "AdaDelta", "GLM"),
        main = "Prediction Accuracy",
        ylab = "Classification Accuracy")

boxplot(results$exec_time_adagrad, results$exec_time_adam, results$exec_time_adasmooth, 
        results$exec_time_adadelta, results$exec_time_glm, 
        names = c("AdaGrad", "Adam", "AdaSmooth", "AdaDelta", "GLM"),
        main = "Execution Time",
        ylab = "Time (ms)")
